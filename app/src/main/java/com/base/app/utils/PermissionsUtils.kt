...
class PermissionsUtils private constructor() {
    ...
    fun checkPermissions(context: Activity, permissions: Array<String>, @NonNull permissionsResult: IPermissionsResult) {
    ...
    fun onRequestPermissionsResult(context: Activity, requestCode: Int, @NonNull permissions: Array<String>, @NonNull grantResults: IntArray) {
